...
function (_React$Component) {
  (0, _inherits2["default"])(PageDesignCoreProvider, _React$Component);
  ...
  function PageDesignCoreProvider() {
    ...
    (0, _classCallCheck2["default"])(this, PageDesignCoreProvider);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(PageDesignCoreProvider)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2["default"])(PageDesignCoreProvider, [{
    key: "getModel",
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2["default"])(_this$props, ["backend"]);
